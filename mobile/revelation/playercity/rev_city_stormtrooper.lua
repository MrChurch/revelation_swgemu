rev_city_stormtrooper = Creature:new {
	...
	templates = {"object/mobile/rev_city_dressed_stormtrooper_m.iff"},
	lootGroups = {
		{
			groups = {
...
CreatureTemplates:addCreatureTemplate(rev_city_stormtrooper, "rev_city_stormtrooper")
