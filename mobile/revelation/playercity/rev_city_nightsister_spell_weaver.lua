rev_city_nightsister_spell_weaver = Creature:new {
	...
	templates = {"object/mobile/rev_city_dressed_dathomir_nightsister_spellweaver.iff"},
	lootGroups = {
		{
			groups = {
...
CreatureTemplates:addCreatureTemplate(rev_city_nightsister_spell_weaver, "rev_city_nightsister_spell_weaver")
