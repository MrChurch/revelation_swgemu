freelancer_transports = Creature:new {
	objectName = "",
	...
	conversationTemplate = "freelancer_transport_template",
	optionsBitmask = 264
}
CreatureTemplates:addCreatureTemplate(freelancer_transports,"freelancer_transports")
