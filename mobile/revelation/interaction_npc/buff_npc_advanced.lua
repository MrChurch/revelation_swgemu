buff_npc_advanced = Creature:new {
	objectName = "",
	customName = "Czerka Corp. Medic",
	faction = "",
	level = 100,
	chanceHit = 0.390000,
	damageMin = 290,
	...
	conversationTemplate = "buff_npc_advanced_template",
	optionsBitmask = 264
}
CreatureTemplates:addCreatureTemplate(buff_npc_advanced,"buff_npc_advanced")
