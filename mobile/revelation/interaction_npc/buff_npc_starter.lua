buff_npc_starter = Creature:new {
	objectName = "",
	customName = "Czerka Corp. Doctor",
	faction = "",
	level = 100,
	chanceHit = 0.390000,
	damageMin = 290,
	...
	conversationTemplate = "buff_npc_starter_template",
	optionsBitmask = 264
}
CreatureTemplates:addCreatureTemplate(buff_npc_starter,"buff_npc_starter")
