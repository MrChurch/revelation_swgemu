costume_npc = Creature:new {
	objectName = "",
	customName = "Czerka 4th July Fun Devision",
	faction = "",
	level = 100,
	chanceHit = 0.390000,
	damageMin = 290,
	...
	conversationTemplate = "costume_template",
	optionsBitmask = 264
}
CreatureTemplates:addCreatureTemplate(costume_npc,"costume_npc")
