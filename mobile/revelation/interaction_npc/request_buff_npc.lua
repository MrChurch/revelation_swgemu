request_buff_npc = Creature:new {
	objectName = "",
	customName = "Czerka Corp. chief executive ",
	faction = "",
	level = 100,
	chanceHit = 0.390000,
	damageMin = 290,
	...
	conversationTemplate = "request_buff_npc_template",
	optionsBitmask = 264
}
CreatureTemplates:addCreatureTemplate(request_buff_npc,"request_buff_npc")
