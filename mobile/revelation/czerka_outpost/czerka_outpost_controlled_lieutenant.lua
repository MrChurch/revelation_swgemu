czerka_outpost_controlled_lieutenant = Creature:new {
	objectName = "",
...
CreatureTemplates:addCreatureTemplate(czerka_outpost_controlled_lieutenant, "czerka_outpost_controlled_lieutenant")
