easy_czerka_outpost_controlled_miner = Creature:new {
	objectName = "",
...
CreatureTemplates:addCreatureTemplate(easy_czerka_outpost_controlled_miner, "easy_czerka_outpost_controlled_miner")
