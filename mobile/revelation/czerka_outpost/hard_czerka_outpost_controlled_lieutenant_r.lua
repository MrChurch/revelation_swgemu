hard_czerka_outpost_controlled_lieutenant_r = Creature:new {
	objectName = "",
...
CreatureTemplates:addCreatureTemplate(hard_czerka_outpost_controlled_lieutenant_r, "hard_czerka_outpost_controlled_lieutenant_r")
