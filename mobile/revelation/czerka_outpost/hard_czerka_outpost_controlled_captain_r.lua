...
hard_czerka_outpost_controlled_captain_r = Creature:new {
	objectName = "",
...
CreatureTemplates:addCreatureTemplate(hard_czerka_outpost_controlled_captain_r, "hard_czerka_outpost_controlled_captain_r")
