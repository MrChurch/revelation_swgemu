hard_czerka_outpost_controlled_guard_r = Creature:new {
	objectName = "",
...
CreatureTemplates:addCreatureTemplate(hard_czerka_outpost_controlled_guard_r, "hard_czerka_outpost_controlled_guard_r")
