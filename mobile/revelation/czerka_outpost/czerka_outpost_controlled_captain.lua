czerka_outpost_controlled_captain = Creature:new {
	objectName = "",
...
CreatureTemplates:addCreatureTemplate(czerka_outpost_controlled_captain, "czerka_outpost_controlled_captain")
