rev_rebel_army_captain = Creature:new {
	...
	baseHAMmax = 26600,
	armor = 1,
	resists = {55,55,55,55,55,10,10,-1,-1},
	meatType = "",
	meatAmount = 0,
	hideType = "",
	hideAmount = 0,
...
CreatureTemplates:addCreatureTemplate(rev_rebel_army_captain, "rev_rebel_army_captain")
