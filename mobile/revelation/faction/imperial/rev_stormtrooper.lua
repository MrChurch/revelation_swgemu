rev_stormtrooper = Creature:new {
	...
	baseHAMmax = 12800,
	armor = 1,
	resists = {35,35,40,35,35,35,35,-1,-1},
	meatType = "",
	meatAmount = 0,
	hideType = "",
	hideAmount = 0,
	...
	tamingChance = 0,
	ferocity = 0,
	pvpBitmask = ATTACKABLE, AGRESSIVE,
...
CreatureTemplates:addCreatureTemplate(rev_stormtrooper, "rev_stormtrooper")
