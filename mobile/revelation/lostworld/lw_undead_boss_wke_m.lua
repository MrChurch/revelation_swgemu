lw_undead_boss_wke_m = Creature:new {
	objectName = "",
	...
	templates = {"object/mobile/outbreak_undead_boss_m_wke_01.iff"},
  lootGroups = {
    {
      groups = {
...
CreatureTemplates:addCreatureTemplate(lw_undead_boss_wke_m, "lw_undead_boss_wke_m")
