...
costume_first_screen = ConvoScreen:new {
	id = "first_screen",
	leftDialog = "",
	customDialogText = "Greetings. I am part of the Czerka 4 July Fun Division. I can apply a costume on you, you can get rid of it with /dropcostume",
...
costume_buffs = ConvoScreen:new {
	id = "select_costume",
	leftDialog = "",
	customDialogText = "You can drop it with /dropcostume",
	stopConversation = "false",
	options = {
		{"A Jawa", "costume_jawa"},
