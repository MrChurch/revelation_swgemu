reb_transitconvo_template = ConvoTemplate:new {
   ...
   templateType = "Lua",
   luaClassHandler = "gcw_rebel_transit_system_convo_handler",
   screens = {}
}
...
reb_transitconvo_template:addScreen(transit_convo_first_screen);
...
reb_transitconvo_template:addScreen(transit_convo_sFlightplan);
...
reb_transitconvo_template:addScreen(transit_convo_about_quest);
...
reb_transitconvo_template:addScreen(transit_convo_deny_quest);

transit_convo_wrong_faction = ConvoScreen:new {
   id = "wrong_faction",
   leftDialog = "",
   customDialogText = "You are no member of the rebel forces",
   stopConversation = "true",
   options = {   
   }
}
reb_transitconvo_template:addScreen(transit_convo_wrong_faction);
...
reb_transitconvo_template:addScreen(transit_convo_notenough_faction);
