...
snowarmor_rebel_bracer_r = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/wearables/armor/rebel_snow/armor_rebel_snow_bracer_r.iff",
...
addLootItemTemplate("snowarmor_rebel_bracer_r", snowarmor_rebel_bracer_r)
