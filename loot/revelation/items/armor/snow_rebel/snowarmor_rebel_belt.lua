...
snowarmor_rebel_belt = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/wearables/armor/rebel_snow/armor_rebel_snow_belt.iff",
	craftingValues = {
		{"armor_rating",1,1,0},
...
addLootItemTemplate("snowarmor_rebel_belt", snowarmor_rebel_belt)
