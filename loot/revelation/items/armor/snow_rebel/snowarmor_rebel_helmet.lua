...
snowarmor_rebel_helmet = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/wearables/armor/rebel_snow/armor_rebel_snow_helmet.iff",
...
addLootItemTemplate("snowarmor_rebel_helmet", snowarmor_rebel_helmet)
