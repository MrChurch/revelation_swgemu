...
snowarmor_rebel_bicep_r = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/wearables/armor/rebel_snow/armor_rebel_snow_bicep_r.iff",
...
addLootItemTemplate("snowarmor_rebel_bicep_r", snowarmor_rebel_bicep_r)
