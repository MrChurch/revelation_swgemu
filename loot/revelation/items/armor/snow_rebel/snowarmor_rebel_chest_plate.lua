...
snowarmor_rebel_chest_plate = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/wearables/armor/rebel_snow/armor_rebel_snow_chest_plate.iff",
...
addLootItemTemplate("snowarmor_rebel_chest_plate", snowarmor_rebel_chest_plate)
