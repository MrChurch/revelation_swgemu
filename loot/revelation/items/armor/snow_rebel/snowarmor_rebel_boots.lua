...
snowarmor_rebel_boots = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/wearables/armor/rebel_snow/armor_rebel_snow_boots.iff",
	craftingValues = {
		{"armor_rating",1,1,0},
...
addLootItemTemplate("snowarmor_rebel_boots", snowarmor_rebel_boots)
