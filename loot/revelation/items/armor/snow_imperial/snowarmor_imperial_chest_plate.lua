...
snowarmor_imperial_chest_plate = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/wearables/armor/snowtrooper/armor_snowtrooper_chest_plate.iff",
...
addLootItemTemplate("snowarmor_imperial_chest_plate", snowarmor_imperial_chest_plate)
