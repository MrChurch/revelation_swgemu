...
snowarmor_imperial_bicep_l = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/wearables/armor/snowtrooper/armor_snowtrooper_bicep_l.iff",
...
addLootItemTemplate("snowarmor_imperial_bicep_l", snowarmor_imperial_bicep_l)
