...
snowarmor_imperial_leggings = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/wearables/armor/snowtrooper/armor_snowtrooper_leggings.iff",
	craftingValues = {
		{"armor_rating",1,1,0},
...
addLootItemTemplate("snowarmor_imperial_leggings", snowarmor_imperial_leggings)
