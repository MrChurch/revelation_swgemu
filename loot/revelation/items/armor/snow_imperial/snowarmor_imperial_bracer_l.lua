...
snowarmor_imperial_bracer_l = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/wearables/armor/snowtrooper/armor_snowtrooper_bracer_l.iff",
	craftingValues = {
		{"armor_rating",1,1,0},
...
addLootItemTemplate("snowarmor_imperial_bracer_l", snowarmor_imperial_bracer_l)
