...
snowarmor_imperial_bicep_r = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/wearables/armor/snowtrooper/armor_snowtrooper_bicep_r.iff",
...
addLootItemTemplate("snowarmor_imperial_bicep_r", snowarmor_imperial_bicep_r)
