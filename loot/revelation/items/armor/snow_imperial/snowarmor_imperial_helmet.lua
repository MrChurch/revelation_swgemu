...
snowarmor_imperial_helmet = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/tangible/wearables/armor/snowtrooper/armor_snowtrooper_helmet.iff",
...
addLootItemTemplate("snowarmor_imperial_helmet", snowarmor_imperial_helmet)
