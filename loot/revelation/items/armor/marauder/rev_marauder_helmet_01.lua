...
rev_marauder_helmet_01 = {
	minimumLevel = 0,
	maximumLevel = 0,
	customObjectName = "",
	directObjectTemplate = "object/tangible/wearables/armor/marauder/armor_marauder_s01_helmet.iff",
	craftingValues = {
		{"armor_rating",1,1,0},
...
addLootItemTemplate("rev_marauder_helmet_01", rev_marauder_helmet_01)