...
rev_marauder_bracer_l_03 = {
	minimumLevel = 0,
	maximumLevel = 0,
	customObjectName = "",
	directObjectTemplate = "object/tangible/wearables/armor/marauder/armor_marauder_s03_bracer_l.iff",
	craftingValues = {
		{"armor_rating",1,1,0},
...
addLootItemTemplate("rev_marauder_bracer_l_03", rev_marauder_bracer_l_03)