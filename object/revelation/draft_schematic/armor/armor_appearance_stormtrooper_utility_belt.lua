...
object_revelation_draft_schematic_armor_armor_appearance_stormtrooper_utility_belt = object_revelation_draft_schematic_armor_shared_armor_appearance_stormtrooper_utility_belt:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Stormtrooper Utility Belt",
...
ObjectTemplates:addTemplate(object_revelation_draft_schematic_armor_armor_appearance_stormtrooper_utility_belt, "object/draft_schematic/armor/armor_appearance_stormtrooper_utility_belt.iff")
