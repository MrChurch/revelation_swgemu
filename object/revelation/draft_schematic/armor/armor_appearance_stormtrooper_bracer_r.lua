...
object_revelation_draft_schematic_armor_armor_appearance_stormtrooper_bracer_r = object_revelation_draft_schematic_armor_shared_armor_appearance_stormtrooper_bracer_r:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Stormtrooper Right Bracer",
...
ObjectTemplates:addTemplate(object_revelation_draft_schematic_armor_armor_appearance_stormtrooper_bracer_r, "object/draft_schematic/armor/armor_appearance_stormtrooper_bracer_r.iff")
