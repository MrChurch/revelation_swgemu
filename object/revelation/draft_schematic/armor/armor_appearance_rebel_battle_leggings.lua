...
object_revelation_draft_schematic_armor_armor_appearance_rebel_battle_leggings = object_revelation_draft_schematic_armor_shared_armor_appearance_rebel_battle_leggings:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Rebel Battle Pants",
...
ObjectTemplates:addTemplate(object_revelation_draft_schematic_armor_armor_appearance_rebel_battle_leggings, "object/draft_schematic/armor/armor_appearance_rebel_battle_leggings.iff")
