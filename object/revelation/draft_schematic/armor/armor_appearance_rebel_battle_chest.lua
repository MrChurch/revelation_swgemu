...
object_revelation_draft_schematic_armor_armor_appearance_rebel_battle_chest = object_revelation_draft_schematic_armor_shared_armor_appearance_rebel_battle_chest:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Rebel Battle Chest Plate",
...
ObjectTemplates:addTemplate(object_revelation_draft_schematic_armor_armor_appearance_rebel_battle_chest, "object/draft_schematic/armor/armor_appearance_rebel_battle_chest.iff")
