...
object_revelation_draft_schematic_armor_armor_appearance_rebel_battle_helmet = object_revelation_draft_schematic_armor_shared_armor_appearance_rebel_battle_helmet:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Rebel Battle Helmet",
...
ObjectTemplates:addTemplate(object_revelation_draft_schematic_armor_armor_appearance_rebel_battle_helmet, "object/draft_schematic/armor/armor_appearance_rebel_battle_helmet.iff")
