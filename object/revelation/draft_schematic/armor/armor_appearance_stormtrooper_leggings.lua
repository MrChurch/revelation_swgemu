...
object_revelation_draft_schematic_armor_armor_appearance_stormtrooper_leggings = object_revelation_draft_schematic_armor_shared_armor_appearance_stormtrooper_leggings:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Stormtrooper Pants",
...
ObjectTemplates:addTemplate(object_revelation_draft_schematic_armor_armor_appearance_stormtrooper_leggings, "object/draft_schematic/armor/armor_appearance_stormtrooper_leggings.iff")
