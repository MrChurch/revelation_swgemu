...
object_revelation_draft_schematic_armor_armor_appearance_assault_trooper_bicep_l = object_revelation_draft_schematic_armor_shared_armor_appearance_assault_trooper_bicep_l:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Assault Trooper Left Bicep",
...
ObjectTemplates:addTemplate(object_revelation_draft_schematic_armor_armor_appearance_assault_trooper_bicep_l, "object/draft_schematic/armor/armor_appearance_assault_trooper_bicep_l.iff")
