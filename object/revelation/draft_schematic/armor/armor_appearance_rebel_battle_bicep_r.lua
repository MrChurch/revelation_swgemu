...
object_revelation_draft_schematic_armor_armor_appearance_rebel_battle_bicep_r = object_revelation_draft_schematic_armor_shared_armor_appearance_rebel_battle_bicep_r:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Rebel Battle Right Bicep",
...
ObjectTemplates:addTemplate(object_revelation_draft_schematic_armor_armor_appearance_rebel_battle_bicep_r, "object/draft_schematic/armor/armor_appearance_rebel_battle_bicep_r.iff")
