...
object_revelation_draft_schematic_armor_armor_appearance_assault_trooper_helmet = object_revelation_draft_schematic_armor_shared_armor_appearance_assault_trooper_helmet:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Assault Trooper Helmet",
...
ObjectTemplates:addTemplate(object_revelation_draft_schematic_armor_armor_appearance_assault_trooper_helmet, "object/draft_schematic/armor/armor_appearance_assault_trooper_helmet.iff")
