...
object_building_poi_scout_camp_rev_s4 = object_building_poi_shared_scout_camp_rev_s4:new {
	...
	skillMods = {{"private_safe_logout", 1},{"private_med_battle_fatigue", 12}, {"private_medical_rating", 135}, {"private_med_wound_health", 80}, {"private_med_wound_action", 80}, {"private_aggro_mod", 75}, {"private_buff_mind", 135}},
    ...
    {templateFile = "object/tangible/crafting/station/public_clothing_station.iff", 
      x = -6, z = 0, y = -8, 
      ox = 0, oy = 0, oz = 0, ow = -.67,  
      cellid = -1, 
      containmentType = -1},
                                 
    {templateFile = "object/static/installation/mockup_power_generator_solar_style_1.iff", 
      x = 12, z = 0, y = -12, 
      ox = 0, oy = 0.422, oz = 0, ow = -0.906, 
      cellid = -1, 
      containmentType = -1},

    {templateFile = "object/static/structure/military/military_wall_weak_rebl_16_style_01.iff", 
      x = 0, z = -2, y = -12, 
      ox = 0, oy = 0, oz = 0, ow = -1,   
      cellid = -1, 
      containmentType = -1},
...
ObjectTemplates:addTemplate(object_building_poi_scout_camp_rev_s4, "object/building/poi/scout_camp_rev_s4.iff")
