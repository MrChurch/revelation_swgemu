...
object_building_poi_scout_camp_rev_s5 = object_building_poi_shared_scout_camp_rev_s5:new {
	templateType = CAMPSTRUCTURE,
	lotSize = 0,
	baseMaintenanceRate = 0,
	basePowerRate = 0,
	
	skillMods = {{"private_safe_logout", 1},{"private_med_battle_fatigue", 15}, {"private_medical_rating", 140}, {"private_med_wound_health", 100}, {"private_med_wound_action", 100}, {"private_aggro_mod", 100}, {"private_buff_mind", 145}},
...
ObjectTemplates:addTemplate(object_building_poi_scout_camp_rev_s5, "object/building/poi/scout_camp_rev_s5.iff")
