...
object_building_faction_perk_hq_hq_rev_s04_rebel = object_building_faction_perk_hq_shared_hq_rev_s04_rebel:new {
  lotSize = 0,
    faction = "rebel",
    pvpFaction = "rebel",
    pvpStatusBitmask = 0,
    ...
    childCreatureObjects = {
      ...
      { mobile="senior_specforce_marine", x=-30, z=0, y=6, cellid=-1, respawn=360, containmentType=-1, heading=0},
      { mobile="senior_specforce_wilderness_scout", x=-28, z=0, y=4, cellid=-1, respawn=360, containmentType=-1, heading=0},
      { mobile="at_xt", x=-40, z=0, y=2, cellid=-1, respawn=360, containmentType=-1, heading=0},
      { mobile="senior_specforce_heavy_weapons_specialist", x=-26, z=0, y=6, cellid=-1, respawn=360, containmentType=-1, heading=0},
      
      { mobile="at_xt", x=0, z=0, y=55, cellid=-1, respawn=360, containmentType=-1, heading=0},
...
ObjectTemplates:addTemplate(object_building_faction_perk_hq_hq_rev_s04_rebel, "object/building/faction_perk/hq/hq_s04_rev_rebel.iff")
