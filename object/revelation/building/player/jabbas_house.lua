...
object_revelation_building_player_jabbas_house = object_revelation_building_player_shared_jabbas_house:new {
	lotSize = 2,
...
ObjectTemplates:addTemplate(object_revelation_building_player_jabbas_house, "object/building/player/jabbas_house.iff")
