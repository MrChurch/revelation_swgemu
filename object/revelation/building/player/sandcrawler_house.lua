...
object_revelation_building_player_sandcrawler_house = object_revelation_building_player_shared_sandcrawler_house:new {
	lotSize = 2,
	...
	skillMods = {
		...
		{"private_crafting_droid_exp", 5},
		{"private_crafting_droid_ass", 10},
	},
	childObjects = {
...
ObjectTemplates:addTemplate(object_revelation_building_player_sandcrawler_house, "object/building/player/sandcrawler_house.iff")
