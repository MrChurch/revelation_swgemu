...
object_revelation_building_player_generic_small_window_s01 = object_revelation_building_player_shared_generic_small_window_s01:new {
	lotSize = 2,
...
ObjectTemplates:addTemplate(object_revelation_building_player_generic_small_window_s01, "object/building/player/generic_small_window_s01.iff")
